...
import org.jethro.mobile.models.templates.account.AccountType;
...
public class QrCodeGenerator {
     ...
     * @param accountType {@link org.jethro.mobile.ui.enums.AccountType} i.e. SAVINGS or LOAN
    ...
    public static String getAccountDetailsInString(String accountNumber, String officeName,
                                                   org.jethro.mobile.ui.enums.AccountType
                                                           accountType) {
        int accountId = -1;
        if (accountType == org.jethro.mobile.ui.enums.AccountType.SAVINGS) {
            accountId = 0;
        } else if (accountType == org.jethro.mobile.ui.enums.AccountType.LOAN) {
            accountId = 1;
        }
